...
import { ref } from 'vue'
defineProps<{ data:any; execute:(a:string,args?:any)=>Promise<any>; close:()=>void; refresh:()=>Promise<void> }>()
...
<template>
  <div class="chat-page">
    <div class="header"><h2>AI 对话</h2><button class="close" @click="close">×</button></div>
    <div class="msgs">
