...
<style scoped>
.search-overlay { width:100vw; display:flex; flex-direction:column; align-items:center; padding-top:48px; }
.input-row { width:640px; }
.input-wrap { display:flex; align-items:center; gap:10px; padding:12px 16px; background:#fff; border-radius:10px; box-shadow:0 2px 12px rgba(0,0,0,0.1); }
...
.results-panel { width:640px; margin-top:8px; background:#fff; border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.15); padding:8px; max-height:300px; overflow-y:auto; }
.results-panel::-webkit-scrollbar { width:4px; }
.results-panel::-webkit-scrollbar-thumb { background:#e4e7ed; border-radius:2px; }
